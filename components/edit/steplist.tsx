          ...
          <li key={idx}>
            <div className="flex items-start my-5 group">
              ...
              <textarea
                ...
                className=" focus:outline-none overflow-hidden resize-none grow border border-white focus:border-gray-400 hover:focus:border-solid focus:ring-0 hover:border-dashed hover:border-gray-500"
                value={s.content}
